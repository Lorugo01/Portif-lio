...
const WORDS = ["Estudante de Redes e Telecomunicações", "Entusiasta de Tecnologia"];
const TECH_STACK = ["React", "JavaScript", "Node.js", ];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Lorugo01" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/luisrodrigolima/" },
  { icon: Instagram, link: "https://www.instagram.com/lorugolabs/" }
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden flex items-center justify-center" id="Home">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-center lg:text-left"
              ...
              <div className="space-y-4 sm:space-y-6 flex flex-col items-center lg:items-start">
                ...
                {/* Typing Effect */}
                <div className="h-8 flex items-center justify-center lg:justify-start w-full" data-aos="fade-up" data-aos-delay="800">
                ...
                {/* Description */}
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light text-center lg:text-left">
                  Criando Websites Inovadores, Funcionais e Amigáveis ao Usuário para Soluções Digitais.
                </p>
