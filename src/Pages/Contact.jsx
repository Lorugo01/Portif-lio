  ...
  return (
    <>
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Tem alguma pergunta? Me envie uma mensagem e responderei em breve.
        </p>
      </div>
      ...
      >
        <div className="container max-w-2xl mx-auto">
          ...
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Tem algo para discutir? Me envie uma mensagem e vamos conversar.
                </p>
              </div>
            ...
            <form 
              action="https://formsubmit.co/lluisrodrigo2@gmail.com"
              method="POST"
